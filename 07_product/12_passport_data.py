...
parameter = { # POSTECH 여기 parameter 수정 (회원, 비회원 하나씩 가능 -> sql에 append로 설정해놓음)
   "organization":"0002",
#   [회원 로그인 타입]
   "loginType":"0",
...
product_url = "/v1/kr/public/mw/passport-data/status" # POSTECH 여기 URL 수정
...
#c = conn.cursor()
df.to_sql('passport_data', conn, if_exists='append')
